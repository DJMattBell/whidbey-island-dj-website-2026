...
*Architecture and product decisions that a new developer would otherwise have to reverse-engineer. Add a dated entry whenever something non-obvious is decided. Never delete entries — mark them superseded.*
