...
- [content] Old-site testimonials lack dates and source links; imported as `source: direct` until matched to their platform — 2026-09-11
...
(move entries here with the resolving commit or date)
